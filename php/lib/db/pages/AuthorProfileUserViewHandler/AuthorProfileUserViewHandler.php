...
function RateTheAuthor($AuthorId,$UserId,$Rating){
    if(!queryData("UPDATE Rate SET Value = $Rating WHERE Ratee = $AuthorId AND Rater = $UserId;")){
        queryData("INSERT INTO Rate(Value,Ratee,Rater) VALUES($Rating,$AuthorId,$UserId)");
    }
}
