...
<head>
    ...
    <link rel="stylesheet" href="./css/other/navBar/navBarStyle.css" />

    <link rel="stylesheet" href="./css/css/main/heading/pageHead.css" />
    <link rel="stylesheet" href="./css/other/carousel/carousel.css" />
    <link rel="stylesheet" href="./css/other/footer/footer.css"/>
            ...
            <div class="container">
                ...
                <div class="searchBar">
                    <form action="">
                        ...
                        <img src="./icon/icon/main/heading/searchIcon.png" id="searchIcon" />
                    </form>
                </div>
            </div>
        </header>
        <section class="carosal">
            <img src="./icon/other/carousel/leftArrow.png" id="leftArrow" class="carosalArrows">
            <div class="carosalContainer">
                <div class="cards">
                    <img src="./img/other/carousel/information.jpg"/>
                ...
                <div class="cards">
                    <img src="./img/other/carousel/science.jpg"/>
                ...
                <div class="cards">
                    <img src="./img/other/carousel/maths.jpg"/>
                ...
                <div class="cards">
                    <img src="./img/other/carousel/graphic.jpg"/>
                ...
                <div class="cards">
                    <img src="./img/other/carousel/business.png"/>
                ...
                <div class="cards">
                    <img src="./img/other/carousel/language.png"/>
                ...
                <div class="cards">
                    <img src="./img/other/carousel/art.jpg"/>
                ...
                <div class="cards">
                    <img src="./img/other/carousel/music.jpg"/>
                    <h1>Rhythm & Music</h1>
                ...
                <div class="cards">
                    <img src="./img/other/carousel/interests.jpg"/>
            ...
            <img src="./icon/other/carousel/rightArrow.png" id="rightArrow" class="carosalArrows">
        </section>
    </main>
         ...
         <div class="row">
           ...
           <div class="footer-col">
             ...
             <div class="social-links">
                <a href="https://www.gmail.com"><i class="fab fa-email"><img src="../../../icon/other/footer/icons8-email-67.png" height="40cqh" width="40cqh"></i></a>
                <a href="https://www.github.com"><i class="fab fa-github"><img src="../../../icon/other/footer/icons8-github-64.png"height="40cqh" width="40cqh"></i></a>
                <a href="https://www.facebook.com"><i class="fab fa-facebook-f"><img src="../../../icon/other/footer/icons8-facebook-50.png" height="40cqh" width="40cqh"></i></a>
                <a href="https://www.linkedin.com"><i class="fab fa-linkedin-in"><img src="../../../icon/other/footer/icons8-linked-in-50.png" height="40cqh" width="40cqh"></i></a>
                <div>
